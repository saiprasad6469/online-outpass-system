...
const StudentSignup = () => {
    ...
    // Use useEffect to check password match when dependencies change
    useEffect(() => {
        checkPasswordMatch();
    ...
    const handleSubmit = async (e) => {
        ...
        // Section validation (should be 1-2 characters)
            ...
            <div className="signup-container">
                ...
                <div className="signup-body">
                    <form id="signupForm" onSubmit={handleSubmit}>
                        ...
                        <div className="terms">
                            ...
                            <label htmlFor="agreeTerms" className="blue-label">
                                <i className="fas fa-file-contract blue-icon"></i> I agree to the <a href="#" className="blue-link">Terms of Service</a> and <a href="#" className="blue-link">Privacy Policy</a> of the Online Student Out-Pass System.
                            </label>
                        </div>
                    ...
                    <div className="login-link-container">
                        <p>
                            <i className="fas fa-sign-in-alt blue-icon"></i> Already have an account? <Link to="/student-login" className="login-link blue-link">Login here</Link>
                        </p>
                    </div>
