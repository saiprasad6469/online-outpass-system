...
const FAQ = () => {
    ...
    // Download guide (demo function)
    const downloadGuide = () => {
        showNotification('info', 'Downloading user guide...');
        setTimeout(() => {
            showNotification('success', 'User guide downloaded successfully!');
        }, 1000);
    };

    // Show videos (demo function)
    const showVideos = () => {
                                                ...
                                                <div className="faq-question" onClick={() => handleFAQToggle(faq.id)}>
                                                    <div className="question-content">
                                                        ...
                                                        <div className="question-text">
                                                            <h3>{faq.question}</h3>
                                                            <span className={`faq-tag ${faq.category}`}>
                                                                {faq.category}
                                                            </span>
                                                        </div>
                                                    </div>
